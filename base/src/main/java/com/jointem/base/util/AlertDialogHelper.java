...
public class AlertDialogHelper {
    ...
    private AlertDialog initDialog(Context context, String content) {
        ...
        dialog.getWindow().setLayout(DensityUtils.dip2px(context, DEFAULT_WIDTH),
                LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    private AlertDialog initVerticalDialog(Context context) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DensityUtils.dip2px(context, DEFAULT_WIDTH), LinearLayout.LayoutParams.WRAP_CONTENT);
        lp.gravity = Gravity.CENTER;
        view.setLayoutParams(lp);
        verticalDialog.setContentView(view);
        verticalDialog.getWindow().setLayout(DensityUtils.dip2px(context, DEFAULT_WIDTH), LinearLayout.LayoutParams.WRAP_CONTENT);
