...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.jointem.base.view.swiplayoutview.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.jointem.base.view.swiplayoutview.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.jointem.base.view.swiplayoutview.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.jointem.base.view.swiplayoutview.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
